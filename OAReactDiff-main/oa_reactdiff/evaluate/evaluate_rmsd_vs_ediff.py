...
tspath = "/home/yufeiluo/research/transition_state_pred/OAReactDiff-main/oa_reactdiff"
checkpoints = {
...
for num_repeat in range(config["repeats"]):
    ...
    for ii, batch in enumerate(loader):
        ...
        save_pickle(localpath+'/'+str(ii)+'rmsd.pickle', _rmsds, _deltaEs)
    rmsds.append(_rmsds)
    deltaEs.append(_deltaEs)
save_pickle(localpath+'/rmsd.pickle', rmsds, deltaEs)
