...
class PaiNN(nn.Module):
    ...
    def __init__(
        ...
        self.embedding = nn.Embedding(max_embedding, self.n_atom_basis, padding_idx=0)
    ...
    def forward(self, x, positions, edge_index, edge_attr, batch): #edge_attr is not used, to make input the same with other backbone APIs
        """
