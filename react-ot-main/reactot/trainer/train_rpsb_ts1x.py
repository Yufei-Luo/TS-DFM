...
sys.path.append('./')
sys.path.append('../')
sys.path.append('../OAReactDiff-main')
...
checkpoint_path = "/home/yufeiluo/transition_state_pred/OAReactDiff-main/oa_reactdiff/checkpoint/OAReactDiff/leftnet-0-832e717fe62e/pretrained-ts1x-diff.ckpt"
...
ckpt_path = f"checkpoint/{project}/1"
